...
import io.getquill.context.jasync.JAsyncContextTypes
...
abstract class ZioJAsyncContext[D <: SqlIdiom, N <: NamingStrategy, C <: ConcreteConnection] extends ZioContext[D, N]
  with JAsyncContextTypes[D, N]
