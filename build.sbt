...
lazy val root = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      ("io.getquill" %% "quill-core-portable" % "minor_quat_fixes_2-SNAPSHOT").withDottyCompat(scalaVersion.value),
      ("io.getquill" %% "quill-sql-portable" % "minor_quat_fixes_2-SNAPSHOT").withDottyCompat(scalaVersion.value),
