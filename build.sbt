...
lazy val root = project
  ...
  .settings(
    ...
    scalaVersion := "3.0.0-M1", // "0.21.0-RC1", //"0.22.0-bin-20200114-193f7de-NIGHTLY", //dottyLatestNightlyBuild.get,
    ...
    libraryDependencies ++= Seq(
      ...
      "org.scala-lang" % "scala3-compiler_3.0.0-M1" % (scalaVersion.value),
      "org.scalatest" % "scalatest_3.0.0-M1" % "3.2.3" % "test",
      "org.scalatest" % "scalatest-mustmatchers_3.0.0-M1" % "3.2.3" % "test",
    )
  )
