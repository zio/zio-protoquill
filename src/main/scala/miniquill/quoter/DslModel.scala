...
case class MyQuoted(val ast: String, lifts: MyScalarPlanter[_, _])


case class MyScalarPlanter[T, PrepareRow](value: T, encoder: GenericEncoder[T, PrepareRow], uid: String)
