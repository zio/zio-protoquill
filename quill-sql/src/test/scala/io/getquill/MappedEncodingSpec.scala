...
//   // Since `Name` is a case class and we can compute decoders in GenericDecoder for any case class,
//   // defining the mapped decoder for `Name` is not actually needed.
