...
trait ArrayEncoding extends EncodingDsl {
  ...
  implicit def arrayStringEncoder[Col <: Iterable[String]]: Encoder[Col]
  implicit def arrayBigDecimalEncoder[Col <: Iterable[BigDecimal]]: Encoder[Col]
  implicit def arrayBooleanEncoder[Col <: Iterable[Boolean]]: Encoder[Col]
  implicit def arrayByteEncoder[Col <: Iterable[Byte]]: Encoder[Col]
  implicit def arrayShortEncoder[Col <: Iterable[Short]]: Encoder[Col]
  implicit def arrayIntEncoder[Col <: Iterable[Int]]: Encoder[Col]
  implicit def arrayLongEncoder[Col <: Iterable[Long]]: Encoder[Col]
  implicit def arrayFloatEncoder[Col <: Iterable[Float]]: Encoder[Col]
  implicit def arrayDoubleEncoder[Col <: Iterable[Double]]: Encoder[Col]
  implicit def arrayDateEncoder[Col <: Iterable[Date]]: Encoder[Col]
  implicit def arrayLocalDateEncoder[Col <: Iterable[LocalDate]]: Encoder[Col]
  ...
  implicit def arrayIntDecoder[Col <: Iterable[Int]](implicit bf: CBF[Int, Col]): Decoder[Col]
  ...
  implicit def arrayMappedEncoder[I, O, Col[X] <: Iterable[X]](
    implicit
    mapped: MappedEncoding[I, O],
    e:      Encoder[Iterable[O]]
  ): Encoder[Col[I]] = {
    mappedEncoder[Col[I], Iterable[O]](MappedEncoding((col: Col[I]) => col.map(mapped.f)), e)
  }

  implicit def arrayMappedDecoder[I, O, Col[X] <: Iterable[X]](
    implicit
    mapped: MappedEncoding[I, O],
    d:      Decoder[Iterable[I]],
    bf:     Factory[O, Col[O]]
  ): Decoder[Col[O]] = {
    mappedDecoder[Iterable[I], Col[O]](MappedEncoding((col: Iterable[I]) =>
